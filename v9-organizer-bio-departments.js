     ...
     * */
     ...
     try {
         ...
         let closeRow = '</div>';
         let openImageWrapper = '<div class="imageWrapper col-12 col-sm-3 col-md-4 col-xl-3">';
         let closeImageWrapper = '</div>';
         let openBodyWrapper = '<div class="bodyWrapper col-12 col-sm-9 col-md-8 col-xl-9">';
